...
import com.softbox.thefarm.calfProgress

class GetCalvesAdapter(r: Context, options: ArrayList<Stock>) : RecyclerView.Adapter<GetCalvesAdapter.stockViewHolder >(){
    var c=r
    var y = options
    ...
    override fun onBindViewHolder(holder: stockViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            val intent = Intent(c, calfProgress::class.java)
